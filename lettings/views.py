...
def index(request):
    """Function to get all the lettings in a list and generate the template
    with this list(context)"""
...
Maecenas auctor, est ut luctus congue, dui enim mattis enim, ac condimentum
...
justo mattis ullamcorper ac non tellus. In tristique mauris eu velit fermentum,
